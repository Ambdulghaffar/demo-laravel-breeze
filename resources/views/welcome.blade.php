            ...
            <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
                <div class="flex lg:flex-1">
                    <a href="#" class="-m-1.5 p-1.5">
                        <span class="font-bold text-5xl">FS-Masters</span>
                    </a>
                </div>
                ...
                <div class="hidden lg:flex lg:gap-x-12 text-3xl font-semibold text-gray-900">
                    <a href="#" class="">Acceuil</a>
                    <a href="#" class="">Actualités</a>
                    <a href="#" class="">Masters</a>
                    <a href="#" class="">
                        À propos
                    </a>
                </div>
                <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                    <a href="#" class="text-2xl font-semibold text-gray-900">Se connecter<span
